...
const base={teams:[{id:'A',name:'A',wins:1,losses:0,points:100,weeklyLineups:{2:[player('A-QB','QB',20)],3:[player('A-QB','QB',20)]}},{id:'B',name:'B',wins:0,losses:1,points:90,weeklyLineups:{2:[player('B-QB','QB',15)],3:[player('B-QB','QB',15)]}}],schedule:[{week:2,matchups:[['A','B']]}],playoffSpots:1,playoffWeeks:[3],simulations:2000,seed:42,modelVariant:'baseline',nflGames:[]};
