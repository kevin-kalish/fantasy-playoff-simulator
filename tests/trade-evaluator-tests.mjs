...
const input={simulations:1000,seed:77,modelVariant:'baseline',lineupSlots:['QB','RB'],playoffSpots:1,playoffWeeks:[3],teams:[{id:'A',name:'Alpha',wins:2,losses:0,points:200,roster:[p('A-QB','AQ','QB',15),p('A-RB','AR','RB',10)],weeklyLineups:{1:[p('A-QB','AQ','QB',15),p('A-RB','AR','RB',10)],2:[p('A-QB','AQ','QB',15),p('A-RB','AR','RB',10)],3:[p('A-QB','AQ','QB',15),p('A-RB','AR','RB',10)]}},{id:'B',name:'Bravo',wins:1,losses:1,points:180,roster:[p('B-QB','BQ','QB',14),p('B-RB','BR','RB',20)],weeklyLineups:{1:[p('B-QB','BQ','QB',14),p('B-RB','BR','RB',20)],2:[p('B-QB','BQ','QB',14),p('B-RB','BR','RB',20)],3:[p('B-QB','BQ','QB',14),p('B-RB','BR','RB',20)]}}],schedule:[{week:1,matchups:[['A','B']]},{week:2,matchups:[['B','A']]}]};
